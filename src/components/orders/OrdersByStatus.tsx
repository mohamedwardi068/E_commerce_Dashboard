...
const data = [
  { name: "Delivered", value: 1256, color: "#10b981", percentage: "48.9%" }, // emerald-500
  { name: "Shipped", value: 856, color: "#3b82f6", percentage: "33.4%" }, // blue-500
  { name: "Pending", value: 324, color: "#f59e0b", percentage: "12.6%" }, // amber-500
  { name: "Cancelled", value: 132, color: "#ef4444", percentage: "5.1%" }, // red-500
];
